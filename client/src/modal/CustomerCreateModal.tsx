...
const CustomerCreateModal: React.FC<ModalProps> = ({ isOpen, setIsOpen }) => {
  ...
  const submitHandler = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(HostUrls+"/api/customers/create", {
        method: "POST",
      ...
      {isOpen && (
        <div className=" -mt-72 mr-32">
          <div className="flex  items-center justify-center min-h-screen p-4">
            ...
            >
              <div className="bg-gray-50 px-4 md:flex justify-between w-full py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                ...
                <h2 className="md:ml-3 text-[22px] text-orange-400">Create Customer</h2>
              </div>
